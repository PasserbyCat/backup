...
{
    cout << endl;
    cout << setw(8) << "Date" << setw(8) << "Train" << setw(6) << "No."
        << setw(10) << "From" << setw(10) << "To"
        << setw(12) << "Departure" << setw(12) << "Arrival"
        << setw(12) << "Adult"
        << setw(12) << "Concession"
        << setw(6) << "Fare" << setw(12) << "Class" << endl;
    cout << setw(8) << date << setw(14) << trainNumber
        << setw(10) << station[originStation] << setw(10) << station[destinationStation];

    if (originStation > destinationStation) {//北上
        NorthboundTimetable nortrain;
        cout << setw(12) << nortrain.getDepartureTimes(trainNumber, 13 - originStation) << setw(12) << nortrain.getDepartureTimes(trainNumber, 13 - destinationStation);
        if (carClass == 1) {
            cout << setw(9) << adultTicketPrice[originStation][destinationStation] << "*" << setw(2) << adultTickets
            ...
            cout << setw(9) << adultTicketPrice[destinationStation][originStation] << "*" << setw(2) << adultTickets
        ...
        SouthboundTimetable soutrain;
        cout << setw(12) << soutrain.getDepartureTimes(trainNumber, originStation) << setw(12) << soutrain.getDepartureTimes(trainNumber, destinationStation);
        if (carClass == 1) {
            cout << setw(9) << adultTicketPrice[destinationStation][originStation] << "*" << setw(2) << adultTickets
                << setw(9) << adultTicketPrice[destinationStation][originStation] / 2 << "*" << setw(2) << concessionTickets
                << setw(6) << adultTicketPrice[destinationStation][originStation] * adultTickets + adultTicketPrice[destinationStation][originStation] / 2 * concessionTickets
