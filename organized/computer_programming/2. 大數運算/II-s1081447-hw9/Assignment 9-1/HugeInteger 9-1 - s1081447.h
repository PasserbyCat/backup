...
#include "Deque - Student ID - hw9.h"
...
bool HugeInteger< T >::operator<( HugeInteger< T > &right )
{
    ...
    typename deque< T >::reverse_iterator rit1 = this->rbegin();
    typename deque< T >::reverse_iterator rit2 = right.rbegin();
    for (; rit1 != this->rend(); rit1++, rit2++) {
        if (*rit2 > * rit1)
            return true;
...
HugeInteger< T > HugeInteger< T >::operator-( HugeInteger< T > &op2 )
{
   ...
   typename deque< T >::iterator it4 = difference.begin();

   for (++it4; it4 != difference.end(); ++it1, ++it3, ++it4)
       *it3 = *it1 + 10;
   it3 = difference.begin();
   it4 = difference.begin();
   ...
   typename deque< T >::reverse_iterator rit3 = difference.rbegin();
   for (; *rit3 == 0; rit3 = difference.rbegin())
       difference.pop_back();
...
HugeInteger< T > HugeInteger< T >::operator*( HugeInteger< T > &op2 )
{
   ...
   typename deque< T >::reverse_iterator rit3 = product.rbegin();
   for (; *rit3 == 0; rit3 = product.rbegin())
       product.pop_back();
...
HugeInteger< T > HugeInteger< T >::operator/( HugeInteger< T > &op2 )
{
   ...
   unsigned int quotientSize = this->size() - op2.size() + 1;
   HugeInteger quotient(quotientSize);
   HugeInteger buffer(this->size());
   HugeInteger remainder(this->size());

   typename deque< T >::iterator it1 = this->begin();
   typename deque< T >::iterator it2 = op2.begin();
   typename deque< T >::iterator it3 = quotient.begin();
   typename deque< T >::iterator it4 = remainder.begin();
   typename deque< T >::iterator it5 = buffer.begin();

   for (; it4 != remainder.end(); it4++, it1++)
       *it4 = *it1;
   it4 = remainder.begin();
   it1 = this->begin();

   typename deque< T >::reverse_iterator rit5 = buffer.rbegin();
   typename deque< T >::reverse_iterator rit2 = op2.rbegin();
   for (; rit2 != op2.rend(); rit2++, rit5++)
       *rit5 = *rit2;
   rit2 = op2.rbegin();
   rit5 = buffer.rbegin();
   ...
   typename deque< T >::reverse_iterator rit3 = quotient.rbegin();
   for (; rit3 != quotient.rend(); rit3++) {
